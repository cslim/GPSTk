...
/// @file GeoEphemeris.hpp
/// Ephemeris data for GeoNASS.

#ifndef GPSTK_GEOEPHEMERIS_HPP
#define GPSTK_GEOEPHEMERIS_HPP
...
namespace gpstk
{
      ...
      /**
       * Ephemeris information for a single Geostationary (WAAS, EGNOS,MSAS,...) 
	   * satellite.  This class encapsulates the ephemeris navigation message
	   * and provides functions to handle the ephemerides.
       */
   class GeoEphemeris : public Xvt
   {
   public:
      ...
      /** This functions returns accuracy code */
      double geAccCode() const
          throw()
      {
          return accCode;
      };
      /** This functions returns accelerations code */
      Triple getAcc() const
          throw()
      {
          return a;
      ...
      { return step; };
          ...
          */
      GeoEphemeris& setIntegrationStep( double rkStep )
      ...
      GeoEphemeris& setRecord(std::string svSys,
          short prn,
   ...
   protected:
      ...
      double trTime;       ///<Transmission time of message (start of the message) in GPS seconds of the week
      double IODN;         ///<IODN (Issue of Data Navigation, DO229, 8 first bits after Message Type if MT9)
      double accCode;
   ...
   private:
      ...
      friend std::ostream& operator<<( std::ostream& s,
                                       const GeoEphemeris& glo );


   };  // End of class 'GeoEphemeris'

      //@}

}  // End of namespace gpstk

#endif   // GPSTK_GEOEPHEMERIS_HPP
